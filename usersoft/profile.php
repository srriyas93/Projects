...
<section class="content">
    <div class="body_scroll">
        ...
        <?php 
        $q="SELECT id,name FROM tb_customers WHERE id='$session_id'";
        ...
        <div class="container-fluid">
            <form id="editCustomer" name="editCustomer" action="profile-action.php" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="card">
                                    ...
                                    <div class="body row">
                                        <div class="form-group">
                                                <input id="cust_edit_id" name="cust_edit_id" type="hidden" class="form-control" value="<?php echo $session_id ?>" required/>
                                            </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <strong>Name</strong>
                                            <div class="form-group">
                                                <input id="cust_edit_name" name="cust_edit_name" type="text" class="form-control" value="<?php echo $cust_name ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <strong>Email</strong>
                                            <div class="form-group">
                                            <input id="b_edit_email" name="b_edit_email" type="text" class="form-control" value="<?php echo $_SESSION['email_id'] ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container-fluid">
            <form id="editCustomerPass" name="editCustomerPass" method="POST">
                <div class="row clearfix">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="edit_pass" class="btn btn-danger waves-effect" onclick="javascript:formIsValid('profile','editCustomerPass',event);">UPDATE PASSWORD</button>
                   <!--     <button type="button" class="btn btn-danger bg-grey waves-effect" data-dismiss="modal">CLOSE</button>-->                
                    </div>
                </div>
            </div>
