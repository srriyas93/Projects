...
<section class="content">
    <div class="body_scroll">
        ...
        <div class="container-fluid">
                <?php 
                $q="SELECT id,name,email_id,phone_no,raz_account_id,aadhar_num,bank_acc_num,bank_name,ifsc_code FROM tb_bussiness_counsellors WHERE id='$session_id'";
                ...
                ?>
            <form id="addBc" name="addBc" action="profile-edit-action.php" enctype="multipart/form-data" method="POST">
                <div class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <div class="body row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input id="b_edit_raz_id" name="b_edit_raz_id" type="text" class="form-control" value="<?php echo $raz_account_id ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <button type="submit" name="edit" class="btn btn-danger waves-effect">Edit Profile</button>
