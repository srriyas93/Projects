function CheckOldPass(b_edit_id,b_edit_old_pass){
	...
	var url = "bussiness_counsellor-ajax.php?mode=checkPass&b_id="+b_id+"&b_old_pass="+b_old_pass;
...
function ChangePasswordBc(event){
	...
	if(b_pass_new!=b_pass_new_confirm){
		...
		var url = "bussiness_counsellor-ajax.php?mode=BcChangePassword&bc_id="+bc_id+"&b_pass_new="+b_pass_new; // the script where you handle the form input.
