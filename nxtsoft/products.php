            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <!--<div class="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <button class="btn btn-success btn-icon float-right" type="button" data-toggle="modal" ><a href="products_add.php?cid='.$cust_id.'"><i class="zmdi zmdi-plus"></a></i></button> -->
                    </div>
                </div>
            </div>
                                    ...
                                    <td class="aligncenter">
                                        <div class="btn-group dropleft">
                                           ...
                                           <!-- <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href=javascript:void(0);" onClick=javascript:showConfirmMessage1("product",'.$sno.','."'".$prod_status."'".'); title="Status">
