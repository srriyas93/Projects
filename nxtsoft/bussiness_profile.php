                ...
                <div class="row clearfix">
                    ...
                    <?php
                     ...
                     $q = "SELECT
                             ...
                             cb.created_date AS created_date, cb.slug AS slug, cb.vision, cb.mission
                             FROM tb_customers c, tb_customers_business cb, tb_categories cat WHERE 
                             cat.id = cb.category_id AND c.id= cb.customer_id ORDER BY cb.created_date DESC";
                                    ...
                                    <div class="btn-group dropleft">
                                        ...
                                        <div id="dropdown <?php echo $cust_bus_id; ?>"class="dropdown-menu">
                                            ...
                                            <i class="zmdi zmdi-hc-fw margin-right10"></i>Products
                                             ...
                                             <div class="dropdown-divider"></div>
                                             <a class="dropdown-item"  href="javascript:void(0);" onClick="javascript:openMissionPop('<?php echo $cust_bus_id;?>','<?php echo $vision;?>','<?php echo $mission;?>');" title="Change Mission">
