                            ...
                            <div id="DisplayProfile" class="modal-body">
                                    ...
                                    <div class="body row">
                                            <div class="form-group">
                                                <input id="username" name="username" type="hidden" value="<?php echo $cust_bus_id ?>" class="form-control">
                                            </div>
                                        <div class="col-sm-6">
                                            <strong>Facebook Page</strong>
                                            <div class="form-group">
                                                <input id="cust_buss_fb" name="cust_buss_fb" type="text" value="<?php echo $fb ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <strong>Twitter</strong> 
                                            <div class="form-group">
                                                <input id="cust_buss_twitter" name="cust_buss_twitter" type="text" value="<?php echo $twitter ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <strong>Youtube</strong> 
                                            <div class="form-group">
                                                <input id="cust_buss_youtube" name="cust_buss_youtube" type="text" value="<?php echo $youtube ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <strong>Instagram</strong> 
                                            <div class="form-group">
                                                <input id="cust_buss_insta" name="cust_buss_insta" type="text" value="<?php echo $insta ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                            </div>
