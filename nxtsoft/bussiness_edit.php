                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="body row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <strong>Business Logo (350px X 100px)</strong>
                                        <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="body row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                        <textarea id="b_edit_gmap" name="b_edit_gmap" class="form-control" ><?php echo  $google_map; ?></textarea>  
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="body row">
                                     <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                        <input id="b_edit_phone" name="b_edit_phone" type="text" class="form-control" placeholder="Enter Business Contact Number" value="<?php echo $phone; ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <strong>Business E-mail </strong>&nbsp;&nbsp;<span id="emailid" class="errorform"></span>
                                        <div class="form-group">
                                            <input id="b_edit_email" name="b_edit_email" type="text" class="form-control"  placeholder="Enter Business E-mail" onblur="checkEmail()" value="<?php echo  $email; ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <strong> Website URL</strong>
                                            <div class="form-group">
                                            <input id="b_edit_website" name="b_edit_website" type="text" class="form-control" placeholder="Enter wesite url" value="<?php echo  $website_url; ?>"/>
                                        </div>
                                    </div>
                                    <?php
                                     } ?>
